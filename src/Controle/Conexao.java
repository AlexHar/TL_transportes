...
public class Conexao {
    ...
    private static final String caminho = "jdbc:mysql://localhost:3306/TLTransportesPU"; //"jdbc:mysql://localhost:3306/TLTransportesPU";//caminho do banco
    private static final String usuario = "root"; //root";//usuario do banco
